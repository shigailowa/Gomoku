...
\lfoot{\today}
\cfoot{}
\rfoot{Vornam Nachnamee, Vornamee Nac, Vorname Nachnamee} %TODO, würde ich erst am ende eintragen und generieren vorm abschicken, muss ja nicht bei github rumhängen
\renewcommand{\footrulewidth}{.4pt}

%----------------------------------------------------------------


\textwidth15.5cm % 16.5cm
\textheight23cm
\oddsidemargin0.cm
\evensidemargin0.cm
...
\newcommand{\imagewidth}{.4\textheight}%{.7\linewidth}
